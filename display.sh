...
dualleft) xrandr --output $INTERNAL_OUTPUT --mode 1920x1080 --pos 3840x1480 --rotate normal --output $EXTERNAL_OUTPUT --primary --mode 3840x2560 --pos 0x0 --rotate normale --left-of $INTERNAL_OUTPUT ;;
